               ...
               <div className="grid grid-cols-2 gap-4">
                 ...
                 <div className="relative">
                   <input 
                      ...
                      className="absolute inset-x-0 bottom-full mb-2 bg-slate-800 border border-slate-700 rounded-lg px-3 py-2 text-center text-sm focus:outline-none focus:border-indigo-500"
                   />
                   <button 
                     onClick={() => {
                       if(!userName.trim()) return alert("名前を入力してください");
