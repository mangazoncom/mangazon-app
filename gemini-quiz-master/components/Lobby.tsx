      ...
      <div className="bg-slate-800/50 backdrop-blur-md p-8 rounded-2xl border border-slate-700 shadow-xl space-y-6">
        <div>
          ...
          <div className="flex gap-2">
            <div className="bg-slate-900 border border-slate-700 rounded-xl px-5 py-4 text-2xl font-mono text-white tracking-widest w-full text-center">
              {roomId}
            </div>
            <button 
              onClick={copyRoomId}
              className="bg-indigo-600/20 hover:bg-indigo-600/40 text-indigo-300 border border-indigo-500/30 rounded-xl px-4 transition-colors"
            >
              {copied ? <Check size={24} /> : <Copy size={24} />}
            </button>
          </div>
          <p className="text-xs text-slate-500 mt-2 text-center">このIDを友達に共有してください</p>
        </div>
